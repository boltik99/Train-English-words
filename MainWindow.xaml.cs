...
namespace Translate
{
    public partial class MainWindow : Window
    {
        ...
        static int capacity = 1000; // 100
        static int blockAmount = 20; // 10
        ...
        public void bt1_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                var r = new Random();
                number_block = r.Next(1, blockAmount);
